...
public class ItemInListAdapter extends EndlessScrollingAdapter<ItemInOut> {
    ...
    public ItemInListAdapter(Context context, ArrayList<ItemInOut> itemInOutArrayList, int numPerPage,
                             OnAdapterItemClickedListener listener) {
        super(context, itemInOutArrayList, numPerPage);
        this.listener = listener;
    }

    private class ItemInViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private ItemInViewHolder(View itemView) {
            super(itemView);
        ...
        public void bind(ItemInOut itemInOut) {
            ...
            if (itemInOut.getTrType().equals(NetworkConstant.PEMINDAHAN)) {
                typeAndSource += " " + context.getString(R.string.from_x, itemInOut.getSourceLocationName());
            }
            tvType.setText(typeAndSource);
            tvLocationName.setText(itemInOut.getTargetLocationName());
    ...
    protected RecyclerView.ViewHolder onCreateItemViewHolder(LayoutInflater inflater, ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_item_in, parent, false);
        return new ItemInViewHolder(view);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemInViewHolder) {
            ItemInOut itemInOut = getDataList().get(position);

            ItemInViewHolder itemInViewHolder = (ItemInViewHolder) holder;
