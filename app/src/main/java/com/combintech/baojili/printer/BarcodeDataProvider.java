...
public class BarcodeDataProvider implements LWPrintDataProvider {
    ...
    private static final String CODE_128_KEY = "Code-CODE128";
    ...
    public BarcodeDataProvider(Context context, String code, String size) {
        this.context = context;
        this.code = code;
        this.size = size;
        setFormName("Barcode128.plist");
    }
    ...
    public void startOfPrint() {
        ...
        hashMap.put(CODE_128_KEY, this.code+"-"+this.size);
