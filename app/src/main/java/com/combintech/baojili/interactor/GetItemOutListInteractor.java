...
public class GetItemOutListInteractor extends BaseInteractor<ArrayList<ItemInOut>> {

    private String locationId;
    private int start;
    private int row;
    private boolean isDeleted;
    public GetItemOutListInteractor(String locationId, int start, int row, boolean isDeleted) {
