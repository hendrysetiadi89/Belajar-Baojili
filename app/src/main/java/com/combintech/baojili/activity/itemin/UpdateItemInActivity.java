...
import com.combintech.baojili.fragment.itemin.UpdateItemInFragment;
...
public class UpdateItemInActivity extends BaseActivity implements
        UpdateItemInFragment.OnUpdateItemInFragmentListener, DeleteItemTrPresenter.DeleteItemTrView {
    ...
    public static void start(Activity activity, ItemInOut itemInOut) {
        Intent intent = new Intent(activity, UpdateItemInActivity.class);
        intent.putExtra(EXTRA_TR_ITEM, itemInOut);
        activity.startActivityForResult(intent,RequestCode.UPDATE_ITEM_IN_REQUEST_CODE);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            replaceFragment(UpdateItemInFragment.newInstance(), false, UpdateItemInFragment.TAG);
        }
    }
    ...
    private UpdateItemInFragment getUpdateItemInFragment() {
        return (UpdateItemInFragment) getSupportFragmentManager().findFragmentByTag(UpdateItemInFragment.TAG);
    }

    @Override
    public void onSuccessUpdateItemIn() {
