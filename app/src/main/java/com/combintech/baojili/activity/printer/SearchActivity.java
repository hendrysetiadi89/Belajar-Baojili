...
import com.combintech.baojili.printer.DeviceInfo;
...
public class SearchActivity extends Activity {
	...
	class ServiceCallback implements LWPrintDiscoverPrinterCallback {
		 ...
		 *
		 * @see
		 * com.epson.lwprint.sdk.LWPrintDiscoverPrinter.Callback#onFindPrinter
		 * (com.epson.lwprint.sdk.LWPrintDiscoverPrinter, java.util.Map)
		 */
		@Override
		 ...
		 *
		 * @see
		 * com.epson.lwprint.sdk.LWPrintDiscoverPrinter.Callback#onRemovePrinter
		 * (com.epson.lwprint.sdk.LWPrintDiscoverPrinter, java.util.Map)
		 */
		@Override
